...
const RoomDetails = () => {
  ...
  // Prevent errors while room data is loading
  if (!room) {
    return (
      <div className="py-28 md:py-35 text-center">
        Loading...
      </div>
    );
  }
    ...
    <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
        <h1 className="text-3xl md:text-4xl">
          {room.hotel.name}
          <span className="text-sm font-serif ml-2">
            ({room.roomType})
          </span>
        </h1>

        <p className="text-xs font-serif py-1.5 px-3 text-white bg-orange-500 rounded-full">
          20% OFF
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between mt-10">
           ...
           <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500"> 
            <div className="flex flex-col">
             ...
             <div className="flex flex-col">
              ...
              border-gray-300 px-3 py-2 mt-1.5" required/>
            </div>
         ...
         <div className="mt-25 space-y-4">
          {roomCommonData.map((spec , index)=> (
            <div key={index} className="flex items-start gap-2">
              <img src={spec.icon} alt={`${spec.title}-icon`} className="
              w-6.5" />
              <div>
         ...
         <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequuntur neque accusantium cupiditate,
            fugit inventore commodi reprehenderit earum fugiat nobis sit distinctio, necessitatibus, laudantium at veniam maxime dolore facere adipisci! Quo?</p>
         </div>
