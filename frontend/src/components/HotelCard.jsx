...
const HotelCard = ({room, index}) => {
  return (
    <Link to={'/rooms/' + room._id} onClick={()=> scrollTo(0,0)} key={room._id} className='relative max-w-70 w-full shadow-[0px_0px_4px_rgba(0,0,0,0.05)] rounded-xl overflow-hidden bg-white text-gray-500/90'>
